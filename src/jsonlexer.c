...
char accept_stringliteral (size_t offset, char ch, void * info) {
...
void scan_stringliteral (char* src, size_t start, struct LexerScanResult * out) {

  // struct strlit_info * info = malloc(sizeof(struct strlit_info));
  struct strlit_info info;
...
char accept_numberliteral (size_t offset, char ch, void * info) {
...
void scan_numberliteral (char* src, size_t start, struct LexerScanResult * out) {
  struct numlit_info info;
...
char accept_whitespace (size_t offset, char ch, void * info) {
  if (ch == ' ' || ch == '\t' || ch == '\n') return accept_allow;
  return accept_terminator;
}
void scan_whitespace (char* src, size_t start, struct LexerScanResult * out) {
